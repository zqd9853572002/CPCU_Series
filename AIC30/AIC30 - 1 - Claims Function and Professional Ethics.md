Claim Function 和 Professional Ethics
...
- ==claim audit分为quantitative和quanlitative==
...
- ==影响claim handling competency的5个factor==
  ...
  | --------------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
  | Claim environment change (Insurance Professional)   | Consumer/ social/ political force会影响insurance coverage/ legal liability/ damage/ technology<br />- coverage可能会broadened<br />- new court interpretation<br />- property evaluation change<br /><br />未能alert to change会导致coverage/ damage evaluation和settle claim上的error | ==claim environment的change包括<br />- consumer<br />- social<br />- political force influence insurance coverage<br />- legal liability<br />- damage<br />- technology== |
  ...
  | knowledge attrition over time (Adjuster Competency) | continuing education会reinforce claim work basic，refresh knowledge，enhance mastered skill等 | ==随时间推移，human memory会lose knowledge（这属于imperfection），继而会adversely affect claim handling competency==<br />- 特别是那些fundamental，但是not used on a daily basis的knowledge<br />==- 为避免此情况，claim rep应知道如何locate resource（如statutes/ procedure等，而非依赖human memory）== |
  ...
  | ==reward和promotion==                               | claim rep应了解competent claims handling的intrinsic value（在financial and advancement opportunity之外） | ==claim rep在perform work时，应始终保持ethical obligation，否则则会发生inequitable reward and promotion== |

- 面临time conflict时，claim rep可能不愿(reluctant) pursue continuing education，但continuing education对maintain competency非常重要
...
- ==各州的license law各有不同，但都约定了who is required to be licensed，以及licensing procedure/ requirement==

  |                       | 解释                                                         |
  | --------------------- | ------------------------------------------------------------ |
  | license范围           | ==大部分州都要求public adjuster有license==<br /><br />有些州只要求independent adjuster和public adjuster要有license<br /><br />有些州要求staff claim rep/ vehicle damage appraiser/ property appraiser都要有license |
  | license的要求         | ==有的licensing law要求claim rep要通过examination，pay fee，并提供continuing education evidence== |
  | ==temporary license== | ==处理catastrophe claim时，各州通常会为out-of-state claim rep提供temporary license== |

- ==和inside claim rep licensing相关的state law会非常ambiguous（不明确），这会引起claim rep的ethical and professional dilemmas==

- ==如果claim在其not licensed territory上处理claim时，可能会发生licensure-related ethical concern==

  > claim manager认为claim rep可以legally take assignment，但claim rep可能会有ethical concern。此时，claim rep可以咨询professional claim association/ regulator published guideline/ attorney来解决concern

## 4. Customer Service

- ==claim customer service包括prompt and courteous contact和prompt payment==
