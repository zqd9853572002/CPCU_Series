...
- 要考虑sender credibility
  ...
  - 和insured/ claimant/ attorney communicate时，claim rep应evaluate credibility effect
...
- active listening的claim rep可和insured/ claimant/ witness建立better rapport，继而能在investigation interview/ claim negotiation中收到better cooperation
...
- Common Response 和 Active Listening Response

  | Insureds Statement                                           | Claim Reps possible response                       | Better, Active Listening response                            |
  | ------------------------------------------------------------ | -------------------------------------------------- | ------------------------------------------------------------ |
  | 然后我到达了山顶，它是如此的明亮。 我没想到这一点，甚至没有时间放下遮阳板。 他们看不到任何东西。 然后，ba！ 就是这样。 | What was it?                                       | Im not sure I understand. Are you saying that the collision occurred just after your car cleared the hilltop and you were blinded by the sun? |
  | 大保险公司都是一样，我失去了家，但是我确定你会找到不给我钱的理由 | 您可以信任我们。我们是专业人士。                   | 您担心不会treated fairly                                     |
  | 我不知道我要怎么生存，我已经失去了一切                       | 你的房子不是total loss。而且您很幸运，没有人受伤。 | 您刚刚经历过一次痛苦的经历，并且您担心从这里出发要重新站起来 |
  | 我的房子刚被烧毁，现在您要我列出所有被摧毁的东西以及年份。我怎么可能记得呢？ | 如果您不告诉我们您损失了什么，我们将无法为您赔偿。 | 听起来，似乎您对损失和记录损失所需的document感到不知所措     |

- 被问到accident相关的question时，人们可能会给出noncommittal reply，这种reply通常会在interview中被忽略（overlook）

  - active listening可帮助claim rep发现vague/ indefinite reply，进而寻找immediate clarification

    > claim rep提问，'Did you hear the ambulances siren before you pulled out from the stop sign?'，insured回答'Not really.'，claim rep会提问additional question（如'when did you first become aware of the siren?），以确定insured是否hear siren/ 没记住hearing/ heard but didn’t think it was so close/ ignore it

## 3. Effective Active Listening的Barrier（障碍）

- active listening会遇到barrier，继而降低其effectiveness

  - conversation的setting会产生environment barrier

  - barrier包括noise，distracting activity，其他人的interruption，uncomfortable temperature/ chair等

    > 如claim rep反复检查muted cellphone是否有incoming call，说明其对未给insured complete attention

- ==以下action/ attitude会造成effective active listening的barrier==

  | 会造成effective active listening的barrier | 解释                                                         | mark                                                         |
  | ----------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
  | ==对each response使用same wording==       | “I hear you saying…”，‘you feel that…’都属于repetitive       |                                                              |
  | pretend to understand                     | 假装听懂（而非seek clarification）                           | listener可以说I didn’t get it, what are you saying           |
  | Overreaching                              | listener ascribe meaning超过speaker expressed的，会frustrate speaker | as I passed by co-workers cubicle, I said hello. Suddenly there was a cart being pushed in from of me from behind the cubicle, and I crashed into it'. A claims representatives response 'You weren't paying attention to where you were going and ran into the cart', might be considered overreaching. |
  | ==Underreaching==                         | 如果listener repeatedly understate（低估）speaker intended message的significance，则会导致 speaker withhold information（隐瞒信息） | insured might say 'I was paralyzed in terror that the care was going to hit my child.' A claims representatives reply that begins, 'So you were worried about your child' minimizes the speakers feelings. |
  | Engaging in long windedness               | listener的long/ complex response会 interrupt information flow，继而让claimant/ insured感到overwhelm/ confuse | -                                                            |
  | Ignore nonverbal cues                     | 如果ignore cue（speaker gesture/ posture/ facial expression等），listener会错过important information，继而导致misinterpret message | 如果speaker的nonverbal cue和spoken message属于incongruent，则listener可以request clarification |
  | violate speaker expectation               | 给出not appropriate situation的reflective response属于violation of speaker expectation | insured说需要钱，直到house repaired，但claim rep回复可以推荐motel，属于not address speakers concern |
  | Exhibiting boredom or loss of focus       | active listening意味着关注speaker和intended message如果listener mind wander，则其不会actively listen | -                                                            |
  | Conveying insincerity                     | A claims representative who feigns concern or empathy for an insured or a claimant may be going through the motions of active listening but is not using the technique effectively. | -                                                            |
...
- 由于email会live forever，claim rep在write email时，应当take special care
  - claim related email可能会展现在court上
  - carefully written message有助于efficient and effective claim handling
...
- 很多email message属于internal（有的email会使用relaxed tone，而非formal business letter/ symbol/ emoji/ email abbreviation/ excessive punctuation（multiple exclamation point等），但应避免punctuation

# 四、Verbal Claim Communication

- effectively communicate ability对claim rep的success非常重要（essential）
...
## 1. 进行claim communication的people type

- ==和claim rep进行verbal exchange的人包括insured，agent and broker，claimant, attorney, service provider, internal management==

- claim rep必须能和不同的人进行effective communication（不同的人要使用不同的effective communication tool and technique）

- maintain consistently professional approach的同时，claim rep应根据调整期verbal exchange中的person type来调整style和terminology

  - 能和不同的人进行communication非常重要

  - ==effective communication要求理解其他人的perspective==

    | ==Types of People（claim rep要接触的6种人的类型）== | Perspectives                                                 |
    | --------------------------------------------------- | ------------------------------------------------------------ |
    | Insured                                             | First-Party Claims<br />- 可能会injured和或under emotional stress<br />- 可能不熟悉claim process和insurance language<br /><br />Third-Party Claims<br />- 关注liability，cost，alleging injury/ damage的人的condition<br />- 可能不熟悉claim process和insurance language |
    | ==Agent<br /><br />Broker==                         | ==了解insurance language和claim process<br /><br />通常代表insured进行communication== |
    | Claimant                                            | 不熟悉claim process和insurance terminology<br /><br />可能injured和或under emotional stress<br /><br />wary（警惕）或frightened |
    | Attorney                                            | Plaintiff Attorney<br />- 会negotiate benefit or settlement<br />- 熟悉claim process和insurance terminology<br />- 可能verbally provocative<br /><br />Defense Attorney<br />- 代表保险公司和或insured<br />- 熟悉claim process和insurance terminology<br />- bill for telephone conversation |
    | Service Providers                                   | Medical Providers<br />- 了解treating physician，phsician conducting independent medical examinations (IME)和expert witnesses的不同观点，非常重要<br />- Nurse case manager的关注点和claim rep不同（即使受雇于同一个insurer也是）<br /><br />Investigator<br />- 需要清楚的沟通investigation purpose和parameter<br /><br />Others<br />- 对claim process和insurance terminology有不同的understanding level |
    | Internal Management                                 | 不同management level的type/ method/ style均不一样<br /><br />对claim function的理解各不相同（如claim manager对claim的理解和underwriting manager对claim的理解不同） |

How could a claims representative approach a telephone conversation with an insured who has been injured in a sever auto accident.
...
- communication是一个collaborative process（涉及和其他方一起work，以attain mutual goal）
  ...
  > 如claim rep应和insured/ claimant一起工作，以对claim decision达成mutually agreeable outcome
  >
