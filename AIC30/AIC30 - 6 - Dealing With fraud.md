...
- telematics和IOT（Internet of things）为保险公司提供了越来越多的data，其中的某些data可用于prevent fraud
  ...
  - employee wearable data可以prevent WC fraud
    ...
    > 如果GPS可以追踪employee movement，将vest连接到IOT，则employer和保险公司可对比employee event version，但此时必须考虑employee privacy

## 2. State Government

- ==combat insurance fraud的legal effort responsibility和city/ state/ federal regulatory body连在一起（包括state insurance department，state fraud bureau，law enforcement agency）==

- ==很多州设立了anti-fraud legislation==

  - ==将insurance fraud的definition扩展到包括reckless conduct==
  - ==增加insurance fraud的civil and criminal penalty==
  - 发生suspected fraud时，让保险公司和law enforcement authority合作
  - ==给予share suspected fraud information的保险公司以broad immunity from civil lawsuit==
  - 要求保险公司成立SIU，制定anti-fraud plan，并在all application/ claim form上加上fraud warning
  
- state level的anti-fraud方式

  |                                | 解释                                                         | mark                                                         |
  | ------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
  | ==Pre-inspection law==         | ==为解决auto theft和fraudulent auto-repair facility的dual problem，有些州要求保险公司在provide insurance前，要physically inspect vehicle<br /><br />pre-inspection program对reduce theft claim for nonexistent 或phantom vehicle很有效，其也能阻止inaccurate reporting garage location（会导致lower-than-adequate premium）== | 有些州要求在pre-inspection中要有photographic documentation   |
  | ==Mandatory reporting==        | 保险公司和law enforcement的information sharing cooperation非常重要<br /><br />==大部分州的法律要求，如果发现suspicions claim，必须向law enforcement authority报告== | 如果没有mandatory reporting law，保险公司可能hesitant to report fraud，因为如果不能prove allegation，保险公司会面临civil suit |
  | ==immunity law==               | ==为保护报告了potentially fraudulent claim的保险公司，state采用了immunity statute（免于保险公司被诉defamation/ harassment/ malicious prosecution/ bad faith/ breach of privacy）<br /><br />如果保险公司report information，但后来发现没有fraud/ malice/ criminal intent，大部分statutes会grant immunity== | 各jurisdiction的immunity statutes不一样，在make report前应当review statutes |
  | ==Civil and criminal penalty== | anti-fraud effort开始逐渐涉及civil/ administrative action，以punish made fraudulent insurance claim的人 | ==对fraud case pursue civil action的优点<br />- 可从wrongdoer处recover civil damage<br />- 让civil/ criminal prosecution更容易== |
  | ==Fraud prevention bureaus==   | state fraud bureau会评估保险公司提交的potentially fraudulent case<br /><br />评估完referral，并收集好enough evidence后，information会交给prosecutor<br /><br />fraud bureau非常effective，fraudsters会将目标（target）转移至tracking/ monitoring system较弱或没有的state（migrating fraud）<br /><br />==statistics显示，criminal conviction number不断growing，特别是fraud bureau已经运行多年的州== | Prosecutor可在任一investigation phase内介入（具体时间取决于particular case）<br /><br />State fraud bureau的operation scope非常vary scope of operations may vary<br />- 如隶属于state police department的state insurance fraud bureau的operation scope，大于（broader）隶属于state insurance department的insurance fraud bureau的operation scope |

## 3. Federal Government

- 以下federal statutes可帮助fight against insurance fraud

  | federal statute                                         | 定义                                                         | mark                                                         |
  | ------------------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
  | Motor Vehicle Theft Law Enforcement Act（MVTLEA，1984） | 用以降低motor vehicle theft incidence，同时facilitate stolen motor vehicle的tracing和recovery | 为识别stolen vehicle/ part，其需要manufacture在high-theft passenger car的engine/ transmission等12个major body part上刻上vehicle identification number (VIN)<br /><br />作为alternative，manufacture也可在car line上安装anti-theft device（作为standard equipment） |
  | Anti car theft Act（ACTA，1992）                        | 建立在MVTLEA上                                               | 增加MVTLEA的covered vehicle line number（通过将deal with stolen marked part作为federal crime的方式）<br /><br />建立national motor vehicle title information system(NMVTIS)，以帮助collect/ disseminate theft and recovery information |
  | US Mail Fraud Statute（USMFS）                          | USMFS将fraud定义为使用US mail，通过false or fraudulent representation的方式获取money/ property的scheme | 为获得mail fraud conviction，prosecutor必须证明fact surrounding the offer是intentionally misrepresented，且其依赖US mail来执行scheme |
  | False Representation Statute（FRS）                     | FRS是在难以证明fraudulent intent时，保护public（包括保险公司）免受aggravated monetary loss的civil law | 如果postal office根据postal inspector获得的evidence来起诉fraudsters，postal office只需证明fraudsters做出的representation（money/ property sought through the mail）是false的 |
