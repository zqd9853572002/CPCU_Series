...
- Blockchain可协助claim process
  ...
  - 即使insurance contract没有记录在blockchain上，smart contract也可提供帮助
    ...
    > 如果汽车发生accident，则和汽车的sensor/ telematics 绑定在一起的smart contract会向保险公司提供first report of loss，同时通知recommended repair shop，并提醒被保险人next step
...
- `如果first notice of loss是lawsuit，则claim rep必须注意response lawsuit的deadline（各州不一样`
  - `claim rep应在investigation开始时，将lawsuit转给counsel，并按照保险公司的procedure来确定是否要出具reservation of right letter (RORL)`
  - reservation of right letter/ ROR是说明coverage issue，并告知被保险人，保险公司正在handling claim的信，且告知被保险人保险公司可能会deny coverage
...
- `claim handling process中的6个activity`
  ...
  |                                             | 解释                                                         | mark                                                         |
  | ------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
  | `Acknowledging and assigning the claim`     | 通知被保险人，已经收到claim                                  | 可能会提供claim rep的name/ contact info<br /><br />可能提供claim number |
  | `identify policy`                           | 确定保单市场承保loss，以及loss是否在policy effective period内发生 | 此部分会highlight需要further investigation的claim aspect     |
  | `联系insured/ insured rep`                  | 第一次和被保险人或insured rep（如lawyer/ public adjuster）接触，可让claim rep介绍并解释claim process | 可让被保险人确定其claim正在被处理，且treated fairly          |
...
- Objective
  - Illustrate these activities in the claims handling process: Acknowledging and assigning the claim; Identifying the policy; Contacting the insured or the insureds representative.
...
- reservation of right letter（RORL）
  ...
  - `RORL的目的和nonwaiver agreement的目的相同，但其属于letter form，且属于unilateral document，RORL不需要被保险人sign，也不需要被保险人agree to letter content`
...
- `通过prior claim investigation，claim rep可确保只赔偿保险公司需要负责的new claim`
...
Coverage analysis is the process of examining a policy by reviewing all its component parts and applying them to the facts of a claim. A claim representative begins the process of coverage determination by carefully reading the policy form and all endorsements.
