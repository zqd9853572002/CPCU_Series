...
- ==digram是可以clarify event==
- ==diagram，比描述accident occurred的written report更加简洁（more succinct）==
- claim rep可使用diagram来interview witness
- 有的witness会认为如果draw their own diagram，会更容易解释what happened
- `在auto accident investigation中，policy report中包含diagram，claim rep也会produce diagram`

- diagram的内容

  | diagram的内容      | 具体内容                                                     |
  | ------------------ | ------------------------------------------------------------ |
  | ==必须包含的信息== | ==date<br /><br />time<br /><br />location<br /><br />accident date<br /><br />制作diagram的person的name== |
  | accident scene     | street<br /><br />direction of the vehicles before the accident<br /><br />position just before impact<br /><br />their position when they came to rest |
  | 其他信息           | possible obstruction to view<br /><br />grade of the street<br /><br />location of traffic signals<br /><br />skid mark<br /><br />utility poles<br /><br />landmark |

- `diagram会说明taken photo的camera angle`
- police report中的accident scene diagram中的roadway layout，可能是hastily drawn，可能imprecise，可使用on line satellite imagery of the location来verify accuracy
- 准备diagram时，claim rep可使用accident investigation diagram template和stencils of appropriate symbols
  - 可使用software进行electronic diagraming，有些website或mobile app会免费提供simple diagramming function

# 二、Spoliation of Evidence（证据毁灭）

Objective: Describe the following considerations related to spoliation of evidence: The insurers obligation to preserve evidence; What constitutes spoliation of evidence; Available defenses to spoliation claim; Remedies in a spoliation claim.

- 若保险公司未能preserve evidence，则会影响其lawsuit position，可能导致sanction或导致对insurer提起independent lawsuit
...
- `evidence preservation对thorough claim investigation/ protect insured and insurer interest非常重要`
  ...
  - allegation of spoliation of evidence会delay claim resolution，complicate litigation，进而导致court对保险公司实施sanction，兵营乡jury verdict

- `Spoliation是未能preserve供他人在litigation中使用的property`
  - `spoliation通常由court proceeding的document/ electronic file的destruction引起`

Spoliation claims against insurers usually arise from the diminished chances of success of an insured, a third-party claimant, or another party in litigation as a result of the insurers failure to preserve evidence from a claims investigation. Such cases may include subrogation proceedings or lawsuits that arise after a claim has been settled.
...
- 大多数policy要求insured和第三方claimant提供sworn statement，但有例外（exception）
...
- `state/ federal对bodily injury claim的reporting，可帮助aggregate injury information，以develop statistics（用于develop safety regulation or law）`
  ...
  > `有的州使用WC bodily injury claim的statistics，来staff WC regulatory office，并为各种workplace开发state safety code`
  >
